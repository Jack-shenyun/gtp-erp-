            ...
            <TabsContent value="symbols" className="flex-1 overflow-y-auto m-0 p-2 space-y-2">
              ...
              <div className="flex items-center gap-1 flex-wrap">
                {(["all", "CE", "FDA", "NMPA"] as const).map(reg => {
                  const regColors: Record<string, string> = { all: "bg-[#0F2B46]", CE: "bg-blue-600", FDA: "bg-red-600", NMPA: "bg-green-600" };
                  return (
              ...
              <p className="text-[8px] text-gray-400">点击符号添加到画布 | 右键可替换为官方图片</p>
                      ...
                      {syms.map(sym => {
                        ...
                        return (
                          <button key={sym.id}
                            ...
                            className={`flex flex-col items-center gap-0.5 p-1.5 rounded border bg-white hover:bg-blue-50 hover:border-blue-300 transition-colors relative group ${customOverride ? "border-green-300 bg-green-50/30" : "border-gray-200"}`}>
                            {customOverride ? (
              ...
              <p className="text-[8px] text-gray-400 leading-tight">提示：右键点击内置符号可上传官方标准图片替换SVG版本。替换后符号将显示绿色边框和绿点标记。</p>
