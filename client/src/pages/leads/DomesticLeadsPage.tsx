...
export default function DomesticLeadsPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 overflow-hidden">
      ...
      {/* 统计卡片 - 手机端横向滚动 */}
      <div className="flex gap-2 px-3 py-2.5 flex-shrink-0 overflow-x-auto scrollbar-none" style={{ scrollbarWidth: 'none' }}>
        {[
      ...
      {/* 标签页 */}
      <div className="flex gap-1 px-3 flex-shrink-0 overflow-x-auto scrollbar-none" style={{ scrollbarWidth: 'none' }}>
        {[
